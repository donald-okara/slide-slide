# slide-slide
Slide Slide is a modern Android implementation of the classic sliding tile puzzle built with Jetpack Compose and Clean Architecture. Instead of predefined artwork, players create puzzles from their own images, choose the puzzle dimensions, and challenge themselves to restore the original picture by sliding tiles into place. 
